...
func (_m *MockStmtInterface) Query(ctx context.Context, args ...interface{}) (RowsInterface, error) {
	var _ca []interface{}
	_ca = append(_ca, ctx)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...interface{}) (RowsInterface, error)); ok {
		return rf(ctx, args...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ...interface{}) RowsInterface); ok {
		r0 = rf(ctx, args...)
	} else {
		if ret.Get(0) != nil {
...
func (_m *MockStmtInterface) QueryRow(ctx context.Context, args ...interface{}) RowInterface {
	var _ca []interface{}
	_ca = append(_ca, ctx)
	_ca = append(_ca, args...)
	ret := _m.Called(_ca...)
	...
	var r0 RowInterface
	if rf, ok := ret.Get(0).(func(context.Context, ...interface{}) RowInterface); ok {
		r0 = rf(ctx, args...)
	} else {
		if ret.Get(0) != nil {
