...
func (_m *MockSQL) Get(ctx context.Context, dest any, q squirrel.Sqlizer) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, any, squirrel.Sqlizer) error); ok {
		r0 = rf(ctx, dest, q)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *MockSQL) Select(ctx context.Context, dest any, q squirrel.Sqlizer) error {
	ret := _m.Called(ctx, dest, q)
