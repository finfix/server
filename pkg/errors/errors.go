...
type CustomError struct {
	ErrorType   `jsonapi:"-"`
	HumanText   string  `jsonapi:"humanTextError"`
	DevelopText string  `jsonapi:"developerTextError"`
	Err         error   `jsonapi:"-"`
	Path        string  `jsonapi:"path"`
	Context     *string `jsonapi:"context,omitempty" validate:"required"`
}
