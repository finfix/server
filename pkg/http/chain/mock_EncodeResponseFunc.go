...
func (_m *MockEncodeResponseFunc) Execute(_a0 context.Context, _a1 http.ResponseWriter, _a2 any) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, http.ResponseWriter, any) error); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Error(0)
	}
