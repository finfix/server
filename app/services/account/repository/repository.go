...
func (repo *Repository) CreateAccountGroup(ctx context.Context, req model2.CreateAccountGroupReq) (uint32, error) {
...
func (repo *Repository) CalculateBalancingAmount(ctx context.Context, accountGroupIDs []uint32, dateFrom, dateTo date.Date) (amount []model2.BalancingAmount, err error) {
...
func (repo *Repository) GetAccountGroups(ctx context.Context, filters model2.GetAccountGroupsReq) (accountGroups []model2.AccountGroup, err error) {
...
func (repo *Repository) Create(ctx context.Context, account model2.CreateReq) (id uint32, serialNumber uint32, err error) {
...
func (repo *Repository) Get(ctx context.Context, req model2.GetReq) (accounts []model2.Account, err error) {
...
func (repo *Repository) Update(ctx context.Context, fields model2.UpdateReq) error {
