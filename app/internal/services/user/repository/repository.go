...
func (repo *Repository) Create(ctx context.Context, user model.CreateReq) (uint32, error) {
...
func (repo *Repository) Get(ctx context.Context, filters model.GetReq) (user []model.User, err error) {
...
func (repo *Repository) GetCurrencies(ctx context.Context) (currencies []model.Currency, err error) {
