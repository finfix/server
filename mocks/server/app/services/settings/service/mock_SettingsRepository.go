...
// MockSettingsRepository_GetVersion_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetVersion'
type MockSettingsRepository_GetVersion_Call struct {
	*mock.Call
}

// GetVersion is a helper method to define mock.On call
//   - _a0 context.Context
//   - _a1 applicationType.Type
func (_e *MockSettingsRepository_Expecter) GetVersion(_a0 interface{}, _a1 interface{}) *MockSettingsRepository_GetVersion_Call {
	return &MockSettingsRepository_GetVersion_Call{Call: _e.mock.On("GetVersion", _a0, _a1)}
}

func (_c *MockSettingsRepository_GetVersion_Call) Run(run func(_a0 context.Context, _a1 applicationType.Type)) *MockSettingsRepository_GetVersion_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(applicationType.Type))
	})
	return _c
}

func (_c *MockSettingsRepository_GetVersion_Call) Return(_a0 model.Version, _a1 error) *MockSettingsRepository_GetVersion_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSettingsRepository_GetVersion_Call) RunAndReturn(run func(context.Context, applicationType.Type) (model.Version, error)) *MockSettingsRepository_GetVersion_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *MockSettingsRepository_UpdateCurrencies_Call) Run(run func(ctx context.Context, rates map[string]decimal.Decimal)) *MockSettingsRepository_UpdateCurrencies_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(map[string]decimal.Decimal))
	})
	return _c
}
...
func (_c *MockSettingsRepository_UpdateCurrencies_Call) RunAndReturn(run func(context.Context, map[string]decimal.Decimal) error) *MockSettingsRepository_UpdateCurrencies_Call {
	_c.Call.Return(run)
	return _c
}
