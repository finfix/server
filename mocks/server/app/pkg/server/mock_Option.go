...
func (_m *MockOption) Execute(_a0 *server.Chain) {
	_m.Called(_a0)
}
...
func (_c *MockOption_Execute_Call) Run(run func(_a0 *server.Chain)) *MockOption_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*server.Chain))
	})
	return _c
}
...
func (_c *MockOption_Execute_Call) RunAndReturn(run func(*server.Chain)) *MockOption_Execute_Call {
	_c.Call.Return(run)
	return _c
}
