...
type User struct {
	...
	ID                    uint32                `protobuf:"varint,1,opt,name=ID,proto3" jsonapi:"ID,omitempty"`                                            // Идентификатор пользователя
	Name                  string                `protobuf:"bytes,2,opt,name=name,proto3" jsonapi:"name,omitempty"`                                         // Имя пользователя
	Email                 string                `protobuf:"bytes,3,opt,name=email,proto3" jsonapi:"email,omitempty"`                                       // Электронная почта
	PasswordHash          string                `protobuf:"bytes,4,opt,name=passwordHash,proto3" jsonapi:"passwordHash,omitempty"`                         // Хэш пароля
	VerificationEmailCode *string               `protobuf:"bytes,5,opt,name=verificationEmailCode,proto3,oneof" jsonapi:"verificationEmailCode,omitempty"` // Временный код, приходящий на почту
	TimeCreate            *pbDatetime.Timestamp `protobuf:"bytes,6,opt,name=timeCreate,proto3,oneof" jsonapi:"timeCreate,omitempty"`                       // Дата создания аккаунта
	FCMToken              *string               `protobuf:"bytes,7,opt,name=FCMToken,proto3,oneof" jsonapi:"FCMToken,omitempty"`                           // Токен уведомлений
	DefaultCurrency       string                `protobuf:"bytes,8,opt,name=defaultCurrency,proto3" jsonapi:"defaultCurrency,omitempty"`                   // Валюта по умолчанию
}
...
type GetReq struct {
	...
	IDs    []uint32 `protobuf:"varint,1,rep,packed,name=IDs,proto3" jsonapi:"IDs,omitempty"` // Идентификатор пользователя
	Emails []string `protobuf:"bytes,2,rep,name=emails,proto3" jsonapi:"emails,omitempty"`   // Электронная почта
}
...
type CreateReq struct {
	...
	Email           string                `protobuf:"bytes,1,opt,name=email,proto3" jsonapi:"email,omitempty"`                     // Электронная почта
	PasswordHash    string                `protobuf:"bytes,2,opt,name=passwordHash,proto3" jsonapi:"passwordHash,omitempty"`       // Хеш пароля
	DefaultCurrency string                `protobuf:"bytes,3,opt,name=defaultCurrency,proto3" jsonapi:"defaultCurrency,omitempty"` // Валюта по умолчанию
	Name            string                `protobuf:"bytes,4,opt,name=name,proto3" jsonapi:"name,omitempty"`                       // Имя
	TimeCreate      *pbDatetime.Timestamp `protobuf:"bytes,5,opt,name=timeCreate,proto3" jsonapi:"timeCreate,omitempty"`           // Время создания
}
...
type GetRes struct {
	...
	Users []*User `protobuf:"bytes,1,rep,name=users,proto3" jsonapi:"users,omitempty"`
}
...
type CreateRes struct {
	...
	ID uint32 `protobuf:"varint,1,opt,name=ID,proto3" jsonapi:"ID,omitempty"`
}
...
type GetCurrenciesRes struct {
	...
	Currencies []*Currency `protobuf:"bytes,1,rep,name=currencies,proto3" jsonapi:"currencies,omitempty"`
}
...
type Currency struct {
	...
	Signatura string  `protobuf:"bytes,1,opt,name=signatura,proto3" jsonapi:"signatura,omitempty"` // Сигнатура валюты
	Name      string  `protobuf:"bytes,2,opt,name=name,proto3" jsonapi:"name,omitempty"`           // Название валюты
	Symbol    string  `protobuf:"bytes,3,opt,name=symbol,proto3" jsonapi:"symbol,omitempty"`       // Символ валюты
	Rate      float64 `protobuf:"fixed64,4,opt,name=rate,proto3" jsonapi:"rate,omitempty"`         // Курс валюты
}
...
var file_user_proto_rawDesc = []byte{
	...
	0x73, 0x52, 0x65, 0x73, 0x22, 0x00, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x6c, 0x61, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x79, 0x43, 0x6f, 0x69, 0x6e, 0x2f, 0x73, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x2f, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2f, 0x70, 0x62, 0x55, 0x73, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
